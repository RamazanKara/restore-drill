...
func TestPreflightRequiresEtcdTools(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := New().Preflight(context.Background(), rt, config.BackupConfig{Tool: "snapshot"}, fakeContainer{}, nil)
			if tt.wantErr == "" {
				if err != nil {
...
func TestRestoreRejectsUnsupportedTool(t *testing.T) {
	_, err := New().Restore(context.Background(), newEtcdRuntime("etcd", "etcdctl"), config.BackupConfig{Tool: "rdb"}, fakeContainer{})
...
func TestValidateEtcdChecks(t *testing.T) {
	...
	result, err := New().Validate(context.Background(), rt, fakeContainer{}, []config.Check{
...
func TestValidateRejectsUnsupportedCheckType(t *testing.T) {
	result, err := New().Validate(context.Background(), newEtcdRuntime("etcd", "etcdctl"), fakeContainer{}, []config.Check{
